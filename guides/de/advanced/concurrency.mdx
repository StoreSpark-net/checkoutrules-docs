...
<iframe
  ...
  src="https://www.youtube.com/embed/juTE6EZUL2Q?si=-TsKgOEEPNFae78A"
  title="BeSure Gleichzeitigkeit"
  style={{ border: 0 }}
...
<Note>
  Methodennamen in diesen Beispielen werden ohne Berücksichtigung der Groß- und
  Kleinschreibung abgeglichen, sodass `worldwide`, `Worldwide` und `WORLDWIDE`
...
Der Abgleich von Methodennamen unterscheidet an beiden Stellen nicht zwischen Groß- und Kleinschreibung. Verwenden Sie daher denselben Methodennamen-Text, auch wenn die Groß- und Kleinschreibung keine Rolle spielt.

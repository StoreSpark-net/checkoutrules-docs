...
<CardGroup cols={2}>
  <Card
    ...
    icon="download"
    href="/guides/de/get-started/installation#app-installieren"
  >
  ...
  <Card
    ...
    icon="gear"
    href="/guides/de/get-started/installation#app-öffnen"
  >
  ...
  <Card
    ...
    icon="eye"
    href="/guides/de/get-started/quickstart#regel-testen"
  >

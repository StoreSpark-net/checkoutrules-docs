...
<Warning>
  Condition set selection is only avaiable at rule creation time. You can not
  change the condition set after the rule is created. You will have to create a
  new rule for that, if you need to use a different condition set.
</Warning>

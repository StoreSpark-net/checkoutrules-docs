...
**条件セット** は、あらかじめ定義された条件のグループで、チェックアウトルールをいつ実行するかを制御するために使用できます。これらの条件は、ルール設定の [When](/guides/ja/get-started/concepts#conditions-the-“when”) セレクターで利用可能です。
...
選択した **条件セット** の条件は、ルール [ブロック](/guides/ja/get-started/concepts#block) 内の [When](/guides/ja/get-started/concepts#conditions-the-“when”) セレクターに表示されます。条件セットを切り替えた後、下の "When" セレクターで条件セレクターを開くと、選択した条件セット内の条件が確認できます。

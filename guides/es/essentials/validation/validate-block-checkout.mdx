...
<iframe
  ...
  title="BeSure Validar/Bloquear checkout"
  style={{ border: 0 }}
...
<img
  ...
  alt="Seleccionar regla de validación/bloqueo"
/>

Luego, en la **selección de plantilla**, elige una opción según tus requisitos. En la mayoría de los casos, puedes elegir la regla vacía como punto de partida y modificarla según tus necesidades. Incluso si eliges una plantilla precargada, podrás modificarla más adelante.

<img
  src="/images/essentials/validation/select-rule-template-validate-block-checkout.webp"
  alt="Seleccionar plantilla de regla"
/>
...
<img
  ...
  alt="Configuración de regla 1"
/>

A continuación, en la misma pantalla, selecciona el [comportamiento](/guides/es/get-started/concepts#comportamiento) apropiado para la regla. Puedes elegir **Bloquear el checkout y mostrar mensaje de error**, **Mostrar mensaje de advertencia sin bloquear el checkout** o **Bloquear el checkout solo cuando el cliente intenta completar el pedido**, según cómo quieras que la regla afecte el proceso de checkout.
...
> Como ejemplo, aquí estamos usando el **Conjunto de condiciones 1** predeterminado, configurando la regla para activarse cuando el campo **"Línea de dirección 2 (Apartamento, suite, etc.)"** esté **vacío**, y configurándola para bloquear el checkout. El mensaje de error **"Ingresa dirección completa"** se mostrará bajo el campo **Línea de dirección 2 de envío** en el checkout, requiriendo que los clientes proporcionen su dirección completa antes de proceder.

<img
  src="/images/essentials/validation/condition-set-validation-block-rule.webp"
  alt="Conjunto de condiciones"
/>
...
- Bajo la categoría **General**, puedes seleccionar **"Parte superior de la página de checkout"** para mostrar la acción en la parte superior.

- En **Debajo de estos campos de entrada**, puedes seleccionar mostrar la acción debajo de campos de entrada específicos, como: Correo electrónico, Número de teléfono del cliente, País de envío, Nombre de envío, Apellido de envío, Empresa de envío, Dirección de envío (Línea de dirección 1), Apartamento, suite, etc. de envío (Línea de dirección 2), Ciudad de envío, Provincia / estado de envío, Código postal de envío, Teléfono de envío, País de facturación, Nombre de facturación, Apellido de facturación, Empresa de facturación, Dirección de facturación (Línea de dirección 1), Apartamento, suite, etc. de facturación (Línea de dirección 2), Ciudad de facturación, Provincia / estado de facturación, Código postal de facturación y Teléfono de facturación.
...
<img
  ...
  alt="Menú desplegable de ubicación de acción"
/>

Después de eso, puedes ingresar tu mensaje en el campo **"Mensaje de error"**. El mensaje que ingreses se mostrará en la página de checkout.

<img
  src="/images/essentials/validation/validation-error-message.webp"
  alt="Mensaje de error de validación"
/>

Opcionalmente, puedes agregar traducciones haciendo clic en el botón **"Agregar traducción"** e ingresando el mensaje traducido para los idiomas deseados. El mensaje ingresado antes de agregar traducciones se utilizará como mensaje predeterminado y se mostrará cuando no haya una traducción disponible.

<img
  src="/images/essentials/validation/validation-error-message-after-translation.webp"
  alt="Mensaje de error de validación después de la traducción"
/>
...
Después de dejar el campo Línea de dirección 2 (Apartamento, suite, etc.) **vacío**, la regla de checkout se ejecuta y bloquea el proceso de checkout. Podemos verificar que el mensaje de error **"Ingresa dirección completa"** se muestra bajo el campo **Línea de dirección 2 de envío** en el checkout, como se muestra a continuación.

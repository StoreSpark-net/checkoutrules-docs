...
- Si ninguno de los bloques anteriores coincide, puedes añadir un bloque de respaldo con una condición de [Previous all conditions invalid](/guides/en/essentials/condition-sets/condition-set-1#previous-all-conditions-invalid).

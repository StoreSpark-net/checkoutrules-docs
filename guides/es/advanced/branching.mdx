...
<Note>
  La condición clave aquí es [Previous all conditions
  invalid](/guides/es/essentials/condition-sets/condition-set-1#previous-all-conditions-invalid)
...
- Si ninguno de los bloques anteriores coincide, puedes añadir un bloque de respaldo con una condición de [Previous all conditions invalid](/guides/es/essentials/condition-sets/condition-set-1#previous-all-conditions-invalid).

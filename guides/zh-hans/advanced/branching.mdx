...
<Note>
  这里的关键条件是第二个和第三个块中的
  [之前所有条件无效](/guides/zh-hans/essentials/condition-sets/condition-set-1#previous-all-conditions-invalid)，
...
- 如果之前的块都不匹配，您可以添加一个条件为 [之前所有条件无效](/guides/zh-hans/essentials/condition-sets/condition-set-1#previous-all-conditions-invalid) 的回退块。
...
或者，[复制上一个块](/guides/zh-hans/advanced/block-replication)，并使用 **粘贴图标**将其粘贴到下方，然后修改其条件和操作。

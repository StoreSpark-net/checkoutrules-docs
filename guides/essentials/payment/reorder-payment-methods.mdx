...
To configure the rule, first optionally we can add a name such as "Reorder payment methods" to describe what it does. Then, select the rule [status](/guides/get-started/concepts#status): Testing, Active, or Deactivated.

...
To set these conditions, type one or more tags into the field and choose the appropriate comparison from the dropdown. Separate multiple tags with commas.

> For example, `Has any of these values: VIP, VVIP` → Matches customers who have either the “VIP” or “VVIP” tag.

<img
  src="/images/essentials/condition-sets/customer-tags.png"
  alt="Customer Tags"
/>

## B2B Details
### Customer is a B2B company
This condition checks whether the customer is marked as a **B2B company** in your store records. If the customer is identified as a B2B company, the condition is considered met.

<img src="/images/essentials/condition-sets/customer-is-b2b-company.png" alt="Customer is a B2B Company" />

### Customer is not a B2B company
This condition checks whether the customer is **not** marked as a **B2B company** in your store records. If the customer is not identified as a B2B company, the condition is considered met.

<img src="/images/essentials/condition-sets/customer-is-not-b2b-company.png" alt="Customer is Not a B2B Company" />

### Purchasing company name

This condition checks the customer’s **purchasing company name** against specific criteria, based on one of the following sub-conditions:
...
<img
  src="/images/essentials/condition-sets/purchasing-company-name-contains.png"
...
<img
  src="/images/essentials/condition-sets/purchasing-company-name-empty.png"
  alt="Purchasing Company Name Empty"
/>

### Purchasing company location name

This condition checks the customer’s **purchasing company location name** against specific criteria, based on one of the following sub-conditions:
...
<img
  src="/images/essentials/condition-sets/purchasing-company-location-name-contains.png"
...
<img
  src="/images/essentials/condition-sets/purchasing-company-location-name-empty.png"
...
## Cart Details
### Currency
Used to compare the selected field’s values with one or more specific currencies, based on one of the following sub-conditions:

- **Has any of these values** (Matches if the field contains at least one of the selected currencies)  
- **Does not have any of these values** (Matches if the field does not contain any of the selected currencies)  
- **Has any other value besides these values** (Matches if the field contains currencies other than the selected ones)  
- **Does not have any other value besides these values** (Matches if the field contains only the selected currencies and no others)  
...
<img
  src="/images/essentials/condition-sets/select-currencies.png"
  alt="Multiple Currencies"
/>

### Product vendor
This condition checks the **product vendor** against specific criteria, based on one of the following sub-conditions:
...
<Note>Use * wildcard to match multiple values. For example, Drop* will match Dropship, drop-590 etc. Use ? to match to any single character.</Note>  
> For example, `Has any of these values: Nike, Adidas` → Matches if the product vendor is either “Nike” or “Adidas”.

<img
  src="/images/essentials/condition-sets/product-vendor.png"
  alt="Product Vendor"
/>
...
<img
  src="/images/essentials/condition-sets/count-product-vendor.png"
  alt="Product Vendor Count"
/>

### Product title

This condition checks the **product title** against specific criteria, based on one of the following sub-conditions:
...
<img
  src="/images/essentials/condition-sets/product-title-contains.png"
  alt="Product Title Contains"
/>

### Product type

This condition checks the **product type** against specific criteria, based on one of the following sub-conditions:
...
<img
  src="/images/essentials/condition-sets/product-type-contains.png"
...
<img
  src="/images/essentials/condition-sets/product-type-empty.png"
...
<img src="/images/essentials/condition-sets/order-subtotal-amount-per-sku-has-greater-value.png" alt="Order Subtotal Amount per SKU Has Greater Value" />
...
<Note>Enter the amount in your store currency. Settings > Store Details > Store Currency</Note>

> For example, `is greater than or equals 50` → Matches if any product in the order has a discount amount of 50 or more.  

<img src="/images/essentials/condition-sets/any-product-discount-amount.png" alt="Any Product Discount Amount" />
...
<img src="/images/essentials/condition-sets/any-product-discount-percentage.png" alt="Any Product Discount Percentage" />
...
<img src="/images/essentials/condition-sets/total-product-discount-amount.png" alt="Total Product Discount Amount" />
...
<img src="/images/essentials/condition-sets/total-product-discount-percentage.png" alt="Total Product Discount Percentage" />

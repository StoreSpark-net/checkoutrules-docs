...
<img src="/images/essentials/condition-sets/always.png" alt="Always" />

## Previous all conditions invalid
When all previous conditions are invalid, this condition becomes true, ensuring the action is triggered only if none of the earlier conditions are met.

<Note>Works only when at least one previous condition exists.</Note>

<img src="/images/essentials/condition-sets/previous-all-conditions-invalid.png" alt="Previous All Conditions Invalid" />
...
<img
  src="/images/essentials/condition-sets/customer-logged-in.png"
...
<img
  src="/images/essentials/condition-sets/customer-is-not-logged-in.png"
...
<img
  src="/images/essentials/condition-sets/email-contains.png"
  alt="Email Contains"
/>
...
<img
  src="/images/essentials/condition-sets/email-empty.png"
  alt="Email Empty"
/>
...
<img src="/images/essentials/condition-sets/customer-total-number-of-previous-orders.png" alt="Customer Total Number of Previous Orders" />
...
<Note>
Enter the amount in your store currency. Settings > Store Details > Store Currency
</Note>

> For example,`is greater than or equals 600` → Matches orders with a total amount of 600 or more.

<img src="/images/essentials/condition-sets/order-total-amount.png" alt="Order Total Amount" />
...
<img src="/images/essentials/condition-sets/order-subtotal-amount.png" alt="Order Subtotal Amount" />
...
<Note>
The quantity refers to the **sum of all item quantities** in the order, not the number of distinct products.
</Note>
...
<img
  src="/images/essentials/condition-sets/is-multiple-of-order-total.png"
...
<img
  src="/images/essentials/condition-sets/order-total-is-greater-value.png"
...
<img src="/images/essentials/condition-sets/order-total-weight.png" alt="Order Total Weight" />
...
<img src="/images/essentials/condition-sets/order-total-one-time-purchase-weight.png" alt="Order Total One-Time Purchase Weight" />
...
<img src="/images/essentials/condition-sets/order-total-subscription-weight.png" alt="Order Total Subscription Weight" />
...
1. Enter the **attribute key** in the “Enter key” field.
2. Enter the **value(s)** to match (where applicable).
3. Choose the comparison option from the dropdown.
...
<Note>
Use * wildcard to match partial values. For example, value* will match value123, VALUETEST etc.
</Note>
> **Example for “Has any of these values”**:  
> Key: `delivery_method`  
> Values: `express, pickup`  
> → Matches carts where the `delivery_method` attribute is either `express` or `pickup`.

<img src="/images/essentials/condition-sets/cart-attribute-has-any-values.png" alt="Cart Attribute Has Any Values" />
...
<img src="/images/essentials/condition-sets/cart-attribute-not-empty-value.png" alt="Cart Attribute Not Empty Value" />
...
To set these conditions:
1. Enter the **SKU** in the “Enter SKU” field.
...
<img src="/images/essentials/condition-sets/product-quantity-per-sku-has-greater-value.png" alt="Product Quantity per SKU Has Greater Value" />
...
<img src="/images/essentials/condition-sets/product-quantity-per-sku-divisible-by.png" alt="Product Quantity per SKU Divisible By" />
...
To set these conditions:
1. Enter the **SKU** to exclude in the “Enter SKU” field.
2. Enter the **quantity** in the “Enter quantity” field.
3. Select the comparison option from the dropdown.
...
<img src="/images/essentials/condition-sets/total-quantity-minus-sku-product-sku-has-greater-value.png" alt="Total Quantity – Product Quantity of SKU Has Greater Value" />
...
<img src="/images/essentials/condition-sets/total-quantity-minus-sku-product-sku-divisible-by.png" alt="Total Quantity – Product Quantity of SKU Divisible By" />

## Cart Has Any Items
### SKU
This condition checks the **SKU** against specific criteria, based on one of the following sub-conditions:
...
<Note>Use * wildcard to match multiple SKU values. For example, SKU* will match SKU12, sku-new-1 etc.</Note>

> For example, `Has any of these values: SKU1, SKU2` → Matches if the SKU is either “SKU1” or “SKU2”.  

<img
  src="/images/essentials/condition-sets/skus.png"
  alt="SKUs"
/>
...
<img
  src="/images/essentials/condition-sets/count-sku.png"
  alt="SKU Count"
/>

### Collection
This condition checks the **collection** in the order against specific criteria, based on one of the following sub-conditions:
...
<img src="/images/essentials/condition-sets/collection-selection-popup.png" alt="Collection Selection Popup" />

> For example, `has value of Summer2025` → Matches when the collection is **Summer2025**.

<img src="/images/essentials/condition-sets/collection-has-value-of.png" alt="Collection Condition" />


### Collections
This condition checks the **Collections** against specific criteria, based on one of the following sub-conditions:
...
<img
  src="/images/essentials/condition-sets/collections.png"
  alt="Collections"
/>
...
<img
  src="/images/essentials/condition-sets/popup-collections.png"
...
<img
  src="/images/essentials/condition-sets/count-collections.png"
...
To set these conditions:
1. Enter the **property key** in the “Enter key” field.
2. Enter the **value(s)** to match (where applicable).
3. Choose the comparison option from the dropdown.
...
<img src="/images/essentials/condition-sets/line-item-property-has-any-values.png" alt="Line Item Property Has Any Values" />
...
<img src="/images/essentials/condition-sets/line-item-property-not-empty-value.png" alt="Line Item Property Not Empty Value" />
...
<img src="/images/essentials/condition-sets/line-item-property-values-less-than.png" alt="Line Item Property Values Less Than" />
...
<img src="/images/essentials/condition-sets/cart-has-shipping-product.png" alt="Cart has shipping product (requires delivery)" />
...
<img src="/images/essentials/condition-sets/cart-has-no-shipping-product.png" alt="Cart has no shipping product" />

### Cart has digital product

This condition checks whether the cart contains at least one digital product. If present, the condition is considered met.

<img src="/images/essentials/condition-sets/cart-has-digital-product.png" alt="Cart has digital product" />

### Cart has no digital product

This condition checks whether the cart does not contain any digital product. If no such product is present, the condition is considered met.

<img src="/images/essentials/condition-sets/cart-has-no-digital-product.png" alt="Cart has no digital product" />
...
<img src="/images/essentials/condition-sets/cart-has-one-time-purchase-product.png" alt="Cart has one time purchase product" />
...
<img src="/images/essentials/condition-sets/cart-has-no-one-time-purchase-product.png" alt="Cart has no one time purchase product" />
...
<img src="/images/essentials/condition-sets/cart-has-subscription-product.png" alt="Cart has subscription product" />
...
<img src="/images/essentials/condition-sets/cart-has-no-subscription-product.png" alt="Cart has no subscription product" />

## Product Metafield
### Product variant metafield / Product metafield
...
<img src="/images/essentials/condition-sets/product-variant-metafield-does-not-contains.png" alt="Product Variant Metafield Does Not Contains" />
...
<img src="/images/essentials/condition-sets/product-variant-metafield-greater-value.png" alt="Product Variant Metafield Greater Value" />
...
<img src="/images/essentials/condition-sets/product-variant-metafield-greater-value-or-equals.png" alt="Product Variant Metafield Greater Value Or Equals" />
...
<img
  src="/images/essentials/condition-sets/selected-shipping-method-contains.png"
  alt="Selected Shipping Method Contains"
/>


### Shipping methods available
Used to compare the selected field’s values with one or more specific shipping methods, counts, or states, based on one of the following sub-conditions:

- **Has any of these values** (Matches if the field contains at least one of the listed shipping methods)  
- **Does not have any of these values** (Matches if the field does not contain any of the listed shipping methods)  
- **Has any other value besides these values** (Matches if the field contains shipping methods other than the listed ones)  
- **Does not have any other value besides these values** (Matches if the field contains only the listed shipping methods and no others)  
- **Has number of values greater than or equals** (Matches if the number of available shipping methods is greater than or equal to the specified number)  
- **Has number of values less than or equals** (Matches if the number of available shipping methods is less than or equal to the specified number)  
...
<Note>Use * wildcard to match partial shipping method names. For example, Stand* will match Standard, standard shipping etc.</Note>
...
<img
  src="/images/essentials/condition-sets/multiple-shipping-methods.png"
...
<img
  src="/images/essentials/condition-sets/count-shipping-methods.png"
  alt="Count Shipping Methods"
/>

### Selected shipping type (Ship/Pickup)
Used to compare the selected field’s value with a specific shipping type, based on one of the following sub-conditions:

- **is** (Matches if the field’s value is exactly the selected shipping type)  
- **is not** (Matches if the field’s value is different from the selected shipping type)  
...
> **Example:** `is not: Pickup` → Matches if the selected shipping type is anything other than “Pickup”.

<img
  src="/images/essentials/condition-sets/select-shipping-type.png"
  alt="Select Shipping Type"
/>

## Localiztion
### User language
Used to compare the selected field’s values with one or more specific languages, based on one of the following sub-conditions:

- **Has any of these values** (Matches if the field contains at least one of the selected languages)  
- **Does not have any of these values** (Matches if the field does not contain any of the selected languages)  
- **Has any other value besides these values** (Matches if the field contains languages other than the selected ones)  
- **Does not have any other value besides these values** (Matches if the field contains only the selected languages and no others)  
...
<img
  src="/images/essentials/condition-sets/languages.png"
  alt="Languages"
/>

### Market

Used to compare the selected field’s values with one or more specific markets, based on one of the following sub-conditions:

- **Has any of these values** (Matches if the field contains at least one of the selected markets)  
- **Does not have any of these values** (Matches if the field does not contain any of the selected markets)  
- **Has any other value besides these values** (Matches if the field contains markets other than the selected ones)  
- **Does not have any other value besides these values** (Matches if the field contains only the selected markets and no others)  
...
<img
  src="/images/essentials/condition-sets/market.png"
  alt="Market"
/>

## Shipping Address
### Shipping address is empty
This condition checks if the shipping address field is empty, then triggers the action.
<img
  src="/images/essentials/condition-sets/shipping-address-is-empty.png"
  alt="Shipping Address Is Empty"
/>

### Shipping address is not empty
This condition checks if the shipping address field is not empty, then triggers the action.
<img
  src="/images/essentials/condition-sets/shipping-address-is-not-empty.png"
...
<img
  src="/images/essentials/condition-sets/full-name-does-not-contain.png"
...
<img
  src="/images/essentials/condition-sets/full-name-has-only-english-chars.png"
...
<img
  src="/images/essentials/condition-sets/full-name-has-greater-value.png"
...
<img
  src="/images/essentials/condition-sets/full-name-is-empty.png"
...
<img
  src="/images/essentials/condition-sets/first-name-is-not.png"
...
<img
  src="/images/essentials/condition-sets/first-name-has-only.png"
...
<img
  src="/images/essentials/condition-sets/first-name-has-greater-value.png"
...
<img
  src="/images/essentials/condition-sets/first-name-is-empty.png"
...
<img
  src="/images/essentials/condition-sets/last-name-is-not.png"
...
<img
  src="/images/essentials/condition-sets/last-name-has-only.png"
...
<img
  src="/images/essentials/condition-sets/last-name-has-greater-value.png"
...
<img
  src="/images/essentials/condition-sets/last-name-is-empty.png"
...
<img
  src="/images/essentials/condition-sets/p.o-box-address.png"
  alt="P.O. box address"
/>

### Not P.O. box address
This condition checks if the customer’s address does not contain a P.O. Box. When true, the action will be triggered only for orders going to physical street addresses.

<img
  src="/images/essentials/condition-sets/not-p.o-box-address.png"
...
<img
  src="/images/essentials/condition-sets/address-contains.png"
...
<img
  src="/images/essentials/condition-sets/address-has-only.png"
...
<img
  src="/images/essentials/condition-sets/address-greater-than.png"
...
<img
  src="/images/essentials/condition-sets/address-is-empty.png"
...
<img
  src="/images/essentials/condition-sets/address1-contains.png"
...
<img
  src="/images/essentials/condition-sets/address1-has-only.png"
...
<img
  src="/images/essentials/condition-sets/address1-greater-than.png"
...
<img
  src="/images/essentials/condition-sets/address1-is-empty.png"
...
<img
  src="/images/essentials/condition-sets/address2-contains.png"
...
<img
  src="/images/essentials/condition-sets/address2-has-only.png"
...
<img
  src="/images/essentials/condition-sets/address2-greater-than.png"
...
<img
  src="/images/essentials/condition-sets/address2-is-empty.png"
  alt="Address Line 2 Is Empty"
/>

### Company  
Used to compare the customer’s company name with one or more specific values, counts, or states, based on one of the following sub-conditions:  
...
<img
  src="/images/essentials/condition-sets/company-contains.png"
...
<img
  src="/images/essentials/condition-sets/company-has-only.png"
...
<img
  src="/images/essentials/condition-sets/company-greater-than.png"
...
<img
  src="/images/essentials/condition-sets/company-is-empty.png"
  alt="Company Is Empty"
/>

### Phone number  
Used to compare the customer’s phone number with one or more specific values, counts, or states, based on one of the following sub-conditions:  
...
<img
  src="/images/essentials/condition-sets/phone-number-contains.png"
...
<img
  src="/images/essentials/condition-sets/phone-number-greater-than.png"
...
<img
  src="/images/essentials/condition-sets/phone-number-is-empty.png"
  alt="Phone Number Is Empty"
/>

### Province code / State code
Used to compare the selected field’s values with one or more specific values or states, based on one of the following sub-conditions:

- **Has any of these values** (Matches if the field contains at least one of the listed values)

- **Does not have any of these values** (Matches if the field does not contain any of the listed values)

- **Has any other value besides these values** (Matches if the field contains values other than the listed ones)

- **Does not have any other value besides these values** (Matches if the field contains only the listed values and no others)

- **Is empty** (Matches if the field has no value)

- **Is not empty** (Matches if the field contains any value)
...
<Note>Add 2 or 3 letter province/state code abbreviation in "ISO_3166-2" format only.</Note>
...
<img
  src="/images/essentials/condition-sets/multiple-provinces.png"
...
<img
  src="/images/essentials/condition-sets/province-not-available.png"
  alt="Province or State Not Available"
/>

### Country
Used to compare the selected field’s values with one or more specific countries, based on one of the following sub-conditions:

- **Has any of these values** (Matches if the field contains at least one of the selected countries)  
- **Does not have any of these values** (Matches if the field does not contain any of the selected countries)
- **Has any other value besides these values** (Matches if the field contains countries other than the selected ones) 
- **Does not have any other value besides these values** (Matches if the field contains only the selected countries and no others) 
...
<img
  src="/images/essentials/condition-sets/select-countries.png"
  alt="Multiple Countries"
/>

### Zip code / Postal code
Used to compare the selected field’s values with one or more specific zip or postal codes, based on one of the following sub-conditions:

- **Has any of these values** (Matches if the field contains at least one of the listed values)
- **Does not have any of these values** (Matches if the field does not contain any of the listed values)
- **Has value in between these values** (Matches if the field value falls within the specified range)
- **Does not have value in between these values** (Matches if the field value does not fall within the specified range)
- **Has any other value besides these values** (Matches if the field contains values other than the listed ones)
- **Does not have any other value besides these values** (Matches if the field contains only the listed values and no others)
- **Has only digits** (Matches if the field contains only numeric characters)
- **Does not have only digits** (Matches if the field contains any non-numeric characters)
...
<Note>Use * wildcard to match multiple zip codes. For example, BT* will match BT12, bt-590 etc. Use ? to match to any single character.</Note>

> For example, `Has any of these values: BT*` → Matches all zip/postal codes starting with “BT”.  

<img
  src="/images/essentials/condition-sets/have-zipcodes.png"
  alt="Have Zipcodes"
/>
...
<img
  src="/images/essentials/condition-sets/dont-have-zipcodes.png"
...
<Note>Enter numbers only. All values ranging in between starting value until the last value will be matched, including the starting and last value.</Note>

>  For example, `Has value in between these values: 10000 – 20000` → Matches if the code is between “10000” and “20000”.

<img
  src="/images/essentials/condition-sets/in-between-value-zipcodes.png"
...
<img
  src="/images/essentials/condition-sets/zipcode-no-field-digits.png"
...
<Note>Enter numbers only. All values ranging in between given number of digits will be matched.</Note>

> For example, `Has number of digits in between: 4 – 6` → Matches codes that contain between 4 and 6 digits.  

<img
  src="/images/essentials/condition-sets/in-between-digits-zipcodes.png"
...
<img
  src="/images/essentials/condition-sets/zipcode-no-field.png"
...
To set these conditions:  
1. Enter the **SKU code** for the first product in the **Enter SKU1** field.  
2. Enter the **SKU code** for the second product in the **Enter SKU2** field.  
3. Choose the comparison option from the dropdown.
...
<img src="/images/essentials/condition-sets/sku-quantity-greater-equals.png" alt="SKU Quantity Greater Equals" />
...
<img src="/images/essentials/condition-sets/sku-quantity-multiple.png" alt="SKU Quantity Multiple" />

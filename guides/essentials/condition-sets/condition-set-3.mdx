...
<img src="/images/essentials/condition-sets/customer-tag-has-value-of.png" alt="Customer Tag Condition" />
...
This condition checks the **order’s subtotal one time purchase amount** against specific criteria, based on one of the following sub-conditions:
...
<img src="/images/essentials/condition-sets/order-subtotal-one-time-purchase-amount.png" alt="Order Subtotal One Time Purchase Amount" />

### Order subtotal subscription amount

This condition checks the **order’s subtotal subscription amount** against specific criteria, based on one of the following sub-conditions:
...
<img src="/images/essentials/condition-sets/order-subtotal-subscription-amount.png" alt="Order Subtotal Subscription Amount" />

### Order subtotal digital amount

This condition checks the **order’s subtotal digital amount** against specific criteria, based on one of the following sub-conditions:
...
<img src="/images/essentials/condition-sets/order-subtotal-digital-amount.png" alt="Order Subtotal Digital Amount" />

### Order subtotal physical amount

This condition checks the **order’s subtotal physical amount** against specific criteria, based on one of the following sub-conditions:
...
<img src="/images/essentials/condition-sets/order-subtotal-physical-amount.png" alt="Order Subtotal Physical Amount" />
...
<img src="/images/essentials/condition-sets/order-subtotal-amount-per-product-tag-has-greater-value.png" alt="Order Subtotal Amount per Product Tag Has Greater Value" />
...
<img src="/images/essentials/condition-sets/order-subtotal-amount-minus-product-tag-has-less-value.png" alt="Order Subtotal Amount Minus Product Tag Has Less Value" />
...
<img src="/images/essentials/condition-sets/quantity-per-product-tag-has-greater-value.png" alt="Quantity per Product Tag Has Greater Value" />
...
<img src="/images/essentials/condition-sets/quantity-per-product-tag-divisible-by.png" alt="Quantity per Product Tag Divisible By" />

## Cart Has Any Items
### Product tag

This condition checks the **product tag** in the order against specific criteria, based on one of the following sub-conditions:
...
<img src="/images/essentials/condition-sets/product-tag-has-value-of.png" alt="Product Tag Condition" />

### Product tags
This condition checks the **Product Tags** against specific criteria, based on one of the following sub-conditions:
...
<img
  src="/images/essentials/condition-sets/product-tags.png"
  alt="Product Tags"
/>
...
<img
  src="/images/essentials/condition-sets/count-product-tags.png"
...
<img src="/images/essentials/condition-sets/any-product-cost-per-quantity.png" alt="Any Product Cost Per Quantity" />
...
<img src="/images/essentials/condition-sets/shipping-method-price.png" alt="Shipping Method Price" />
...
### City / Area
Used to compare the selected field’s values with one or more specific values, counts, or states, based on one of the following sub-conditions:
...
- **Has number of digits greater than or equals** (Matches if the number of digits is greater than or equal to the specified number)

- **Has number of digits less than or equals** (Matches if the number of digits is less than or equal to the specified number)
...
<Note>Use * wildcard to match partial city names. For example, Santo* will match santo domingo, santodomngo etc.</Note>

> For example, `Has any of these values: Lahore, Karachi` → Matches if the field contains either “Lahore” or “Karachi”.

<img
  src="/images/essentials/condition-sets/multiple-cities.png"
  alt="Multiple Cities"
/>
...
<img
  src="/images/essentials/condition-sets/count-cities.png"
  alt="Count Cities"
/>
...
<img
  src="/images/essentials/condition-sets/city-available.png"
  alt="City Available"
/>

...
<iframe
  ...
  title="BeSure Hide Express Checkout Options"
  style={{ border: 0 }}
...
<Note>
  In this rule, payment-method matching uses the same semantics as other
  payment method rules:

  - Supported operators are **contains**, **does not contain**, **is**, and
    **is not**.
  - Matching is case-insensitive.
  - `*` wildcard is supported in user input (for example: `Pay*`, `*Express*`,
    `*Pay`).
  ...
  - **Do nothing**: no express-hide action runs when time/date or location

...
<iframe
  ...
  title="BeSure Hide Payment Methods"
  style={{ border: 0 }}
...
<Note>
  ...
  - **Do nothing**: the rule does not run any hide/show action when time/date
    or customer location context cannot be determined.
  - **Do this action**: the rule runs the fallback operation you define instead
    of the regular hide/show operation.
</Note>

...
import CustomerLocationUsingGeoIP from "/snippets/condition-set/en/customer-location-using-geoip.mdx";
...
<Info>
  ...
  the action area:
  <br />
  <strong>Do nothing</strong> or <strong>Do this action</strong>.
</Info>

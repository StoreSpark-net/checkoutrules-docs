...
<iframe
  ...
  title="BeSure Condition Sets Introduction"
  style={{ border: 0 }}
...
Each condition set lists how many conditions are available within it compared to the total. For example, **Condition set 1** `22 / 156` means there are 22 conditions available in Condition set 1 out of 143 total conditions. Here, 143 is the total number of conditions available in all condition sets.

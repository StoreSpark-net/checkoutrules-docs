...
- **Order discount strategy**: First or Maximum (depending on enabled discount type and rule context).
- **Product discount strategy**: First, All, or Maximum (depending on enabled discount type and rule context).

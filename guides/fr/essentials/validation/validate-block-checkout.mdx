...
<iframe
  ...
  title="BeSure Valider/Bloquer le paiement"
  style={{ border: 0 }}
...
Ensuite, dans la **sélection de modèle**, choisissez une option selon vos besoins. Dans la plupart des cas, vous pouvez choisir la règle vide comme point de départ et la modifier selon vos besoins. Même si vous choisissez un modèle prérempli, vous pourrez le modifier plus tard.
...
Pour configurer la règle, nous pouvons d’abord, facultativement, ajouter un nom tel que "Valider/Bloquer le passage en caisse" pour décrire ce qu’elle fait. Ensuite, sélectionnez le [statut](/guides/fr/get-started/concepts#statut) de la règle : Mise à l’essai, Active ou Désactivée.
...
Ensuite, sur le même écran, sélectionnez le [comportement](/guides/fr/get-started/concepts#comportement) approprié pour la règle. Vous pouvez choisir **Bloquer le passage en caisse et afficher un message d’erreur**, **Afficher un message d’avertissement sans bloquer le passage en caisse** ou **Bloquer le passage en caisse uniquement lorsque le client tente de finaliser la commande**, selon la façon dont vous souhaitez que la règle affecte le processus de passage en caisse.
...
> Par exemple, ici nous utilisons l’**Ensemble de conditions 1** par défaut, en définissant la règle pour qu’elle se déclenche lorsque le champ **"Ligne d’adresse 2 (Appartement, suite, etc.)"** est **vide**, et en la configurant pour bloquer le passage en caisse. Le message d’erreur **"Entrez une adresse complète"** sera affiché sous le champ **Ligne d’adresse 2 de livraison** lors du passage en caisse, obligeant les clients à fournir leur adresse complète avant de continuer.
...
- Avec **Sous ces champs de saisie**, vous pouvez choisir d’afficher l’action sous des champs spécifiques, tels que : E-mail, Numéro de téléphone du client, Pays de livraison, Prénom de livraison, Nom de livraison, Société de livraison, Adresse de livraison (Ligne d’adresse 1), Appartement, suite, etc. de livraison (Ligne d’adresse 2), Ville de livraison, Province/État de livraison, Code postal de livraison, Téléphone de livraison, Pays de facturation, Prénom de facturation, Nom de facturation, Société de facturation, Adresse de facturation (Ligne d’adresse 1), Appartement, suite, etc. de facturation (Ligne d’adresse 2), Ville de facturation, Province/État de facturation, Code postal de facturation et Téléphone de facturation.
...
Ensuite, vous pouvez saisir votre message dans le champ **"Message d'erreur"**. Le message que vous saisissez sera affiché sur la page de passage en caisse.

<img
  src="/images/essentials/validation/validation-error-message.webp"
  alt="Message d'erreur de validation"
/>

En option, vous pouvez ajouter des traductions en cliquant sur le bouton **"Ajouter une traduction"** et en saisissant le message traduit pour les langues souhaitées. Le message saisi avant l'ajout des traductions sera utilisé comme message par défaut et sera affiché lorsqu'aucune traduction n'est disponible.

<img
  src="/images/essentials/validation/validation-error-message-after-translation.webp"
  alt="Message d'erreur de validation après traduction"
/>
...
Après avoir laissé le champ Ligne d’adresse 2 (Appartement, suite, etc.) **vide**, la règle de passage en caisse s’exécute et bloque le processus de passage en caisse. Nous pouvons vérifier que le message d’erreur **"Entrez une adresse complète"** est affiché sous le champ **Ligne d’adresse 2 de livraison** lors du passage en caisse, comme indiqué ci-dessous.
